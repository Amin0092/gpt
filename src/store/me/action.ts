...
import {MyAction, RootState, useAppDispatch} from "../store";
import axios from "axios/index";
import {MeAction} from "./reducer";
...
export const meRequestAsync = (): ThunkAction<void, RootState, unknown, MyAction> => (dispatch, getState) => {
        dispatch(meRequest())
        axios
